...
ddsaml2aws login -a govcloud-us1-fed-human-engineering
VERSION=$LAYER_VERSION ARCH=amd64 AWS_PROFILE=govcloud-us1-fed-human-engineering ./scripts/publish_layer.sh
VERSION=$LAYER_VERSION ARCH=arm64 AWS_PROFILE=govcloud-us1-fed-human-engineering ./scripts/publish_layer.sh
